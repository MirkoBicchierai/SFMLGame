#ifndef SFMLGAME_CONCRETESTATEGAME5_H
#define SFMLGAME_CONCRETESTATEGAME5_H
...
class ConcreteStateGame5 : public GameState{
...
public:
    ...
    explicit ConcreteStateGame5(Game* game);
