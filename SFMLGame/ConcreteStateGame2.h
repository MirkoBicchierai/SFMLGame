#ifndef SFMLGAME_CONCRETESTATEGAME2_H
#define SFMLGAME_CONCRETESTATEGAME2_H
...
class ConcreteStateGame2 : public GameState{
...
public:
    ...
    explicit ConcreteStateGame2(Game* game);
